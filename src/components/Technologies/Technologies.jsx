...
const Technologies = () => {
    return (
        <div className='bg-[#f7f7e6] pb-24' id='technologies'>
            <h1 className='text-[4rem] pt-10 text-black font-bold text-center'>My knowledge</h1>
            <div className='flex lg:flex-col justify-center items-center px-10 pt-5'>
                <div className='flex flex-col lg:flex-row justify-center items-center lg:gap-x-16 gap-y-10 lg:gap-y-0 lg:pt-28'> 
